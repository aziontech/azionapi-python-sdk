...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**delete_version**](docs/apis/tags/DefaultApi.md#delete_version) | **delete** /storage/{version_id}/delete | 
*DefaultApi* | [**storage_version_id_post**](docs/apis/tags/DefaultApi.md#storage_version_id_post) | **post** /storage/{version_id} | 
...
If the OpenAPI document is large, imports in storageapi.apis and storageapi.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from storageapi.apis.default_api import DefaultApi`
