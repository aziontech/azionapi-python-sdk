...
class EndpointDatadog(BaseModel):
    """
    EndpointDatadog
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EndpointDatadog:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EndpointDatadog:
        """Create an instance of EndpointDatadog from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EndpointDatadog.parse_obj(obj)

        _obj = EndpointDatadog.parse_obj({
