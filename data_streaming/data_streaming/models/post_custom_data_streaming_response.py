...
class PostCustomDataStreamingResponse(BaseModel):
    """
    ...
    template_model: Optional[StrictStr] = Field(None, description="Note:  * Add all variables and values that will be used to stream according to the data source you choose to use.   ")
    active: Optional[StrictBool] = None
    endpoint: Optional[StrictStr] = None
    all_domains: Optional[StrictBool] = Field(None, description="Note:  * Field not used with the rtm_activity data source. ")
    __properties = ["id", "name", "data_source", "template_model", "active", "endpoint", "all_domains"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostCustomDataStreamingResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostCustomDataStreamingResponse:
        """Create an instance of PostCustomDataStreamingResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostCustomDataStreamingResponse.parse_obj(obj)

        _obj = PostCustomDataStreamingResponse.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
