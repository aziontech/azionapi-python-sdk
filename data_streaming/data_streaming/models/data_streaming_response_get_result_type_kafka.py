...
class DataStreamingResponseGetResultTypeKafka(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataStreamingResponseGetResultTypeKafka:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataStreamingResponseGetResultTypeKafka:
        """Create an instance of DataStreamingResponseGetResultTypeKafka from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataStreamingResponseGetResultTypeKafka.parse_obj(obj)

        _obj = DataStreamingResponseGetResultTypeKafka.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
