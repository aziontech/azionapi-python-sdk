...
class DataStreamingResponseGetResultTypeDatadogDTS(BaseModel):
    """
    ...
    endpoint: Optional[DataStreamingEndpointTypeDatadogDTS] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataStreamingResponseGetResultTypeDatadogDTS:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataStreamingResponseGetResultTypeDatadogDTS:
        """Create an instance of DataStreamingResponseGetResultTypeDatadogDTS from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataStreamingResponseGetResultTypeDatadogDTS.parse_obj(obj)

        _obj = DataStreamingResponseGetResultTypeDatadogDTS.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "template_id": obj.get("template_id"),
            "data_source": obj.get("data_source"),
            "active": obj.get("active"),
            "endpoint": DataStreamingEndpointTypeDatadogDTS.from_dict(obj.get("endpoint")) if obj.get("endpoint") is not None else None,
