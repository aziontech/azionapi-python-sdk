...
class EndpoinrtS3(BaseModel):
    ...
    object_key_prefix: Optional[StrictStr] = None
    bucket_name: Optional[StrictStr] = None
    content_type: Optional[StrictStr] = None
    host_url: Optional[StrictStr] = None
    secret_key: Optional[StrictStr] = None
    __properties = ["endpoint_type", "access_key", "region", "object_key_prefix", "bucket_name", "content_type", "host_url", "secret_key"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EndpoinrtS3:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EndpoinrtS3:
        """Create an instance of EndpoinrtS3 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EndpoinrtS3.parse_obj(obj)

        _obj = EndpoinrtS3.parse_obj({
            "endpoint_type": obj.get("endpoint_type"),
            "access_key": obj.get("access_key"),
            "region": obj.get("region"),
            "object_key_prefix": obj.get("object_key_prefix"),
