...
class EndpointKafka(BaseModel):
    ...
    __properties = ["endpoint_type", "kafka_topic", "bootstrap_servers", "use_tls"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EndpointKafka:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EndpointKafka:
        """Create an instance of EndpointKafka from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EndpointKafka.parse_obj(obj)

        _obj = EndpointKafka.parse_obj({
