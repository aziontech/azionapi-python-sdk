...
class EndpointSplunk(BaseModel):
    """
    EndpointSplunk
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EndpointSplunk:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EndpointSplunk:
        """Create an instance of EndpointSplunk from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EndpointSplunk.parse_obj(obj)

        _obj = EndpointSplunk.parse_obj({
