...
class TemplateResultById(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def results() -> typing.Type['Template']:
                return Template
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'Template': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> typing.Union['Template', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        results: typing.Union['Template', schemas.Unset] = schemas.unset,
