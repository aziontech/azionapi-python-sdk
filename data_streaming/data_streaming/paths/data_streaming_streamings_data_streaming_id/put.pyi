...
class BaseApi(api_client.Api):
    @typing.overload
    def _overwrite_data_streaming_by_id_oapg(
        self,
...
class OverwriteDataStreamingById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def overwrite_data_streaming_by_id(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def overwrite_data_streaming_by_id(
        ...
        return self._overwrite_data_streaming_by_id_oapg(
            body=body,
