...
SchemaFor200ResponseBodyApplicationJson = TemplateResults
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_data_streaming_templates_oapg(
        self,
...
class ListDataStreamingTemplates(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_data_streaming_templates(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def list_data_streaming_templates(
        ...
        return self._list_data_streaming_templates_oapg(
