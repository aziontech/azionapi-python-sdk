...
SchemaFor200ResponseBodyApplicationJson = DataStreamingResponseWithResults
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_data_streamings_oapg(
        self,
...
class ListDataStreamings(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_data_streamings(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def list_data_streamings(
        ...
        return self._list_data_streamings_oapg(
