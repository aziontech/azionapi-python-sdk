...
class CreatePersonalTokenResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uuid", "name", "key", "user_id", "created", "expires_at", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uuid", "name", "key", "user_id", "created", "expires_at", "description", ], str]):
