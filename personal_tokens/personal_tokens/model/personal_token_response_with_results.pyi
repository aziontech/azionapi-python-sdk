    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class links(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["next", "previous", ], str]):
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["next", "previous", ], str]):
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PersonalTokenResponseGet']:
                        return PersonalTokenResponseGet
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['PersonalTokenResponseGet'], typing.List['PersonalTokenResponseGet']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'PersonalTokenResponseGet':
