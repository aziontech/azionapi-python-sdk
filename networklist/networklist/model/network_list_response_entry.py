...
class NetworkListResponseEntry(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "last_editor", "last_modified", "list_type", "name", "items_values", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "last_editor", "last_modified", "list_type", "name", "items_values", ], str]):
