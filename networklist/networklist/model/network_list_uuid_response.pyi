...
class NetworkListUuidResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def results() -> typing.Type['NetworkListUuidResponseEntry']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'NetworkListUuidResponseEntry': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> typing.Union['NetworkListUuidResponseEntry', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        results: typing.Union['NetworkListUuidResponseEntry', schemas.Unset] = schemas.unset,
