...
from networklist.model.network_list_uuid_response_entry import NetworkListUuidResponseEntry
from networklist.model.network_list_uuid_response_entry_int import NetworkListUuidResponseEntryInt
