...
class ListNetworkListsResponse(BaseModel):
    """
    ...
    results: Optional[conlist(NetworkLists)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListNetworkListsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListNetworkListsResponse:
        """Create an instance of ListNetworkListsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListNetworkListsResponse.parse_obj(obj)

        _obj = ListNetworkListsResponse.parse_obj({
            "count": obj.get("count"),
            "total_pages": obj.get("total_pages"),
            "schema_version": obj.get("schema_version"),
            "links": Links.from_dict(obj.get("links")) if obj.get("links") is not None else None,
            "results": [NetworkLists.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
