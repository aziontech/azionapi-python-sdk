...
class NetworkListsResponse(BaseModel):
    """
    NetworkListsResponse
    """
    results: Optional[NetworkListResponseEntry] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkListsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NetworkListsResponse:
        """Create an instance of NetworkListsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkListsResponse.parse_obj(obj)

        _obj = NetworkListsResponse.parse_obj({
            "results": NetworkListResponseEntry.from_dict(obj.get("results")) if obj.get("results") is not None else None,
