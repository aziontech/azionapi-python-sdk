...
from networklist import api_client, exceptions
...
class BaseApi(api_client.Api):
    @typing.overload
    def _network_lists_uuid_delete_oapg(
        self,
...
class NetworkListsUuidDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def network_lists_uuid_delete(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
    ...
    def network_lists_uuid_delete(
        ...
        return self._network_lists_uuid_delete_oapg(
