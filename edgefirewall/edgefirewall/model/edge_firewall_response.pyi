...
class EdgeFirewallResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def results() -> typing.Type['EdgeFirewall']:
                return EdgeFirewall
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'EdgeFirewall': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> typing.Union['EdgeFirewall', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        results: typing.Union['EdgeFirewall', schemas.Unset] = schemas.unset,
