...
class CreateRuleSetRequest(BaseModel):
    ...
    __properties = ["name", "is_active", "behaviors", "criteria"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateRuleSetRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateRuleSetRequest:
        """Create an instance of CreateRuleSetRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateRuleSetRequest.parse_obj(obj)

        _obj = CreateRuleSetRequest.parse_obj({
            "name": obj.get("name"),
