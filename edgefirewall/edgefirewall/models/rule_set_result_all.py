...
class RuleSetResultAll(BaseModel):
    """
    RuleSetResultAll
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RuleSetResultAll:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RuleSetResultAll:
        """Create an instance of RuleSetResultAll from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RuleSetResultAll.parse_obj(obj)

        _obj = RuleSetResultAll.parse_obj({
            "id": obj.get("id"),
