...
class RuleSetResult(BaseModel):
    ...
    RuleSetResult
    """
    results: Optional[RuleSetResultResults] = None
    schema_version: Optional[conint(strict=True, ge=1)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RuleSetResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RuleSetResult:
        """Create an instance of RuleSetResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RuleSetResult.parse_obj(obj)

        _obj = RuleSetResult.parse_obj({
            "results": RuleSetResultResults.from_dict(obj.get("results")) if obj.get("results") is not None else None,
