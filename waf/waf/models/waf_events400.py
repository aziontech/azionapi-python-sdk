...
class WAFEvents400(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WAFEvents400:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WAFEvents400:
        """Create an instance of WAFEvents400 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WAFEvents400.parse_obj(obj)

        _obj = WAFEvents400.parse_obj({
