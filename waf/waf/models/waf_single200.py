...
class WAFSingle200(BaseModel):
    """
    WAFSingle200
    """
    results: Optional[SingleWAF] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WAFSingle200:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WAFSingle200:
        """Create an instance of WAFSingle200 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WAFSingle200.parse_obj(obj)

        _obj = WAFSingle200.parse_obj({
            "results": SingleWAF.from_dict(obj.get("results")) if obj.get("results") is not None else None,
