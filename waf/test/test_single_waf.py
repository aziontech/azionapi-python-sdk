...
from waf.models.single_waf import SingleWAF  # noqa: E501

class TestSingleWAF(unittest.TestCase):
    """SingleWAF unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleWAF:
        """Test SingleWAF
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleWAF`
        """
        model = SingleWAF()  # noqa: E501
        if include_optional:
            return SingleWAF(
                id = 56,
                name = '',
