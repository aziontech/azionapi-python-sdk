...
class Results(BaseModel):
    ...
    __properties = ["id", "name", "language", "code", "json_args", "function_to_run", "initiator_type", "active", "last_editor", "modified", "reference_count", "is_proprietary_code"]
    ...
    def from_dict(cls, obj: dict) -> Results:
        ...
        if not isinstance(obj, dict):
            return Results.parse_obj(obj)

        _obj = Results.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
