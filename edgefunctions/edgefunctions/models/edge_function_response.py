...
class EdgeFunctionResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EdgeFunctionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EdgeFunctionResponse:
        """Create an instance of EdgeFunctionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EdgeFunctionResponse.parse_obj(obj)

        _obj = EdgeFunctionResponse.parse_obj({
