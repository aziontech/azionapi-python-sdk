...
class ListEdgeFunctionResponse(BaseModel):
    """
    ...
    results: Optional[conlist(Results)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListEdgeFunctionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListEdgeFunctionResponse:
        """Create an instance of ListEdgeFunctionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListEdgeFunctionResponse.parse_obj(obj)

        _obj = ListEdgeFunctionResponse.parse_obj({
            "count": obj.get("count"),
            "total_pages": obj.get("total_pages"),
            "schema_version": obj.get("schema_version"),
            "links": Links.from_dict(obj.get("links")) if obj.get("links") is not None else None,
            "results": [Results.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
