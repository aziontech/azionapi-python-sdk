...
class Results(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "language", "code", "json_args", "function_to_run", "initiator_type", "active", "last_editor", "modified", "reference_count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "language", "code", "json_args", "function_to_run", "initiator_type", "active", "last_editor", "modified", "reference_count", ], str]):
