...
class CreateEdgeFunctionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "language", "code", "json_args", "active", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "language", "code", "json_args", "active", ], str]):
