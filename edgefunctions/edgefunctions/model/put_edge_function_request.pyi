...
class PutEdgeFunctionRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "code", "json_args", "active", "initiator_type", "language", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "code", "json_args", "active", "initiator_type", "language", ], str]):
