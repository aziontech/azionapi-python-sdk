...
# body param
SchemaForRequestBodyApplicationJson = CreateEdgeFunctionRequest


request_body_create_edge_function_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _edge_functions_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_edge_function_request.serialize(body, content_type)
...
class EdgeFunctionsPost(BaseApi):
    ...
    def edge_functions_post(
        ...
        return self._edge_functions_post_oapg(
            body=body,
