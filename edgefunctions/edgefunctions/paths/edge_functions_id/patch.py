...
from edgefunctions import api_client, exceptions
...
# body param
SchemaForRequestBodyApplicationJsonVersion3 = PatchEdgeFunctionRequest


request_body_patch_edge_function_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _edge_functions_id_patch_oapg(
        self,
    ...
    def _edge_functions_id_patch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_patch_edge_function_request.serialize(body, content_type)
...
class EdgeFunctionsIdPatch(BaseApi):
    ...
    def edge_functions_id_patch(
        ...
        return self._edge_functions_id_patch_oapg(
            body=body,
