...
# body param
SchemaForRequestBodyApplicationJsonVersion3 = PutEdgeFunctionRequest


request_body_put_edge_function_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _edge_functions_id_put_oapg(
        self,
    ...
    def _edge_functions_id_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_put_edge_function_request.serialize(body, content_type)
...
class EdgeFunctionsIdPut(BaseApi):
    ...
    def edge_functions_id_put(
        ...
        return self._edge_functions_id_put_oapg(
            body=body,
