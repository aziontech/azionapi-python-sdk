...
> ListEdgeFunctionsInstancesResponse edge_firewall_edge_firewall_id_functions_instances_get(page=page, page_size=page_size, sort=sort, order_by=order_by)
...
> EdgeFunctionsInstanceResponse edge_firewall_edge_firewall_id_functions_instances_post(create_edge_functions_instances_request)
...
with edgefunctionsinstance_edgefirewall.ApiClient(configuration) as api_client:
    ...
    try:
        # Create an Edge Functions Instance
        api_response = api_instance.edge_firewall_edge_firewall_id_functions_instances_post(create_edge_functions_instances_request)
...
with edgefunctionsinstance_edgefirewall.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete an Edge Functions Instance by uuid
        api_instance.edge_firewall_edge_firewall_id_functions_instances_uuid_delete(uuid)
    except Exception as e:
...
with edgefunctionsinstance_edgefirewall.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve an Edge Functions Instance set by uuid
        api_response = api_instance.edge_firewall_edge_firewall_id_functions_instances_uuid_get(uuid)
        print("The response of DefaultApi->edge_firewall_edge_firewall_id_functions_instances_uuid_get:\n")
        pprint(api_response)
    except Exception as e:
...
> EdgeFunctionsInstanceResponse edge_firewall_edge_firewall_id_functions_instances_uuid_patch(uuid, body)
...
with edgefunctionsinstance_edgefirewall.ApiClient(configuration) as api_client:
    ...
    try:
        # Update some Edge Functions Instance attributes
        api_response = api_instance.edge_firewall_edge_firewall_id_functions_instances_uuid_patch(uuid, body)
        print("The response of DefaultApi->edge_firewall_edge_firewall_id_functions_instances_uuid_patch:\n")
        pprint(api_response)
    except Exception as e:
...
> EdgeFunctionsInstanceResponse edge_firewall_edge_firewall_id_functions_instances_uuid_put(uuid, body)
...
with edgefunctionsinstance_edgefirewall.ApiClient(configuration) as api_client:
    ...
    try:
        # Overwrite some Edge Functions Instance attributes
        api_response = api_instance.edge_firewall_edge_firewall_id_functions_instances_uuid_put(uuid, body)
        print("The response of DefaultApi->edge_firewall_edge_firewall_id_functions_instances_uuid_put:\n")
        pprint(api_response)
    except Exception as e:
