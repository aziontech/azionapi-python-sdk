...
class CreateEdgeFunctionsInstancesRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "edge_function", "json_args", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "edge_function", "json_args", ], str]):
