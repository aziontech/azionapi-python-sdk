...
class PurgeUrlRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["urls"], typing_extensions.Literal["method"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["urls"], typing_extensions.Literal["method"], ]):
