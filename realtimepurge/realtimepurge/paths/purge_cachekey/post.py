...
# body param
SchemaForRequestBodyApplicationJson = PurgeCacheKeyRequest


request_body_purge_cache_key_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _purge_cache_key_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_purge_cache_key_request.serialize(body, content_type)
...
class PurgeCacheKey(BaseApi):
    ...
    def purge_cache_key(
        ...
        return self._purge_cache_key_oapg(
            body=body,
