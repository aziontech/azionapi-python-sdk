...
# body param
SchemaForRequestBodyApplicationJson = PurgeWildcardRequest


request_body_purge_wildcard_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _purge_wildcard_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_purge_wildcard_request.serialize(body, content_type)
...
class PurgeWildcard(BaseApi):
    ...
    def purge_wildcard(
        ...
        return self._purge_wildcard_oapg(
            body=body,
