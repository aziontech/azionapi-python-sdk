...
class PaginatedS3CredentialList(BaseModel):
    """
    PaginatedS3CredentialList
    """ # noqa: E501
    count: Optional[Annotated[int, Field(le=1000, strict=True, ge=0)]] = None
    next: Optional[StrictStr] = None
    previous: Optional[StrictStr] = None
    results: Optional[List[S3Credential]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [S3Credential.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
