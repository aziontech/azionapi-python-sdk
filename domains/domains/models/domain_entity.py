...
class DomainEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "cnames", "cname_access_only", "is_active", "edge_application_id", "digital_certificate_id", "environment", "is_mtls_enabled", "mtls_trusted_ca_certificate_id", "mtls_verification", "crl_list", "id", "domain_name"]
