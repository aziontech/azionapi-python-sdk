...
# body param
SchemaForRequestBodyApplicationJsonVersion3 = CreateDomainRequest


request_body_create_domain_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_domain_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_domain_request.serialize(body, content_type)
