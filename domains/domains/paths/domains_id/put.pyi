...
from domains import api_client, exceptions
...
# body param
SchemaForRequestBodyApplicationJsonVersion3 = PutDomainRequest


request_body_put_domain_request = api_client.RequestBody(
    content={
        'application/json; version=3': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJsonVersion3),
    },
)
SchemaFor200ResponseBodyApplicationJsonVersion3 = DomainResponseWithResult
...
class BaseApi(api_client.Api):
    ...
    def _put_domain_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_put_domain_request.serialize(body, content_type)
