...
# body param
SchemaForRequestBodyApplicationJsonVersion3 = UpdateDomainRequest


request_body_update_domain_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_domain_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_update_domain_request.serialize(body, content_type)
