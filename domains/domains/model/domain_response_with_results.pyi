...
class DomainResponseWithResults(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def links() -> typing.Type['DomainLinks']:
                return DomainLinks
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'DomainLinks': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'DomainLinks': ...
