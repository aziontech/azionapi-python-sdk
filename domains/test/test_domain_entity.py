...
class TestDomainEntity(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DomainEntity:
        """Test DomainEntity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DomainEntity`
        """
        model = DomainEntity()
        if include_optional:
            return DomainEntity(
