...
class VariableCreate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "value", "secret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "value", "secret", ], str]):
