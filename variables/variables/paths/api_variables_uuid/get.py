...
SchemaFor200ResponseBodyApplicationJson = Variable
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_variables_retrieve_oapg(
        self,
...
class ApiVariablesRetrieve(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_variables_retrieve(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def api_variables_retrieve(
        ...
        return self._api_variables_retrieve_oapg(
