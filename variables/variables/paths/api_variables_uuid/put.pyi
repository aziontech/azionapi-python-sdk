...
from variables import api_client, exceptions
...
# body param
SchemaForRequestBodyApplicationJson = VariableCreate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = VariableCreate
SchemaForRequestBodyMultipartFormData = VariableCreate


request_body_variable_create = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = VariableGet
...
class BaseApi(api_client.Api):
    @typing.overload
    def _api_variables_update_oapg(
        self,
    ...
    def _api_variables_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_variable_create.serialize(body, content_type)
...
class ApiVariablesUpdate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def api_variables_update(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def api_variables_update(
        ...
        return self._api_variables_update_oapg(
            body=body,
