...
class RecordGet(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["record_id"]) -> MetaOapg.properties.record_id: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["record_id", "entry", "description", "answers_list", "policy", "weight", "record_type", "ttl", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["record_id"]) -> typing.Union[MetaOapg.properties.record_id, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["record_id", "entry", "description", "answers_list", "policy", "weight", "record_type", "ttl", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        record_id: typing.Union[MetaOapg.properties.record_id, decimal.Decimal, int, schemas.Unset] = schemas.unset,
