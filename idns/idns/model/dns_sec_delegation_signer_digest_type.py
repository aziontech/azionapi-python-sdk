...
class DnsSecDelegationSignerDigestType(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "slug", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "slug", ], str]):
