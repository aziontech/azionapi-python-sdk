...
class GetZoneResponse(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'Zone': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> typing.Union['Zone', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        results: typing.Union['Zone', schemas.Unset] = schemas.unset,
