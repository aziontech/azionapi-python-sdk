...
# body param
SchemaForRequestBodyApplicationJson = DnsSec


request_body_dns_sec = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _put_zone_dns_sec_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_dns_sec.serialize(body, content_type)
...
class PutZoneDnsSec(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def put_zone_dns_sec(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def put_zone_dns_sec(
        ...
        return self._put_zone_dns_sec_oapg(
            body=body,
