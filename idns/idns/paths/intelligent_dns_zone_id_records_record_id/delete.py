...
class SchemaFor204ResponseBodyApplicationJsonVersion3(
    schemas.StrBase,
    schemas.NoneBase,
    schemas.Schema,
...
_response_for_204 = api_client.OpenApiResponse(
    ...
    content={
        'application/json; version=3': api_client.MediaType(
            schema=SchemaFor204ResponseBodyApplicationJsonVersion3),
    },
)
...
class DeleteZoneRecord(BaseApi):
    ...
    def delete_zone_record(
        ...
        return self._delete_zone_record_oapg(
