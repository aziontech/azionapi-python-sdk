...
SchemaFor200ResponseBodyApplicationJsonVersion3 = PostOrPutRecordResponse
...
class PutZoneRecord(BaseApi):
    ...
    def put_zone_record(
        ...
        return self._put_zone_record_oapg(
            body=body,
