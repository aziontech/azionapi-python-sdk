...
class RecordGet(BaseModel):
    ...
    __properties = ["record_id", "entry", "description", "answers_list", "policy", "weight", "record_type", "ttl"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecordGet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecordGet:
        """Create an instance of RecordGet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecordGet.parse_obj(obj)

        _obj = RecordGet.parse_obj({
