...
class GetZonesResponseLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetZonesResponseLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetZonesResponseLinks:
        """Create an instance of GetZonesResponseLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetZonesResponseLinks.parse_obj(obj)

        _obj = GetZonesResponseLinks.parse_obj({
