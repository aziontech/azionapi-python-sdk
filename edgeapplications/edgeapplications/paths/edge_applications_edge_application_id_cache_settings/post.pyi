...
# body param
SchemaForRequestBodyApplicationJsonVersion3 = ApplicationCacheCreateRequest


request_body_application_cache_create_request = api_client.RequestBody(
    content={
        'application/json; version=3': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJsonVersion3),
    },
)
SchemaFor200ResponseBodyApplicationJsonVersion3 = ApplicationCacheCreateResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _edge_applications_edge_application_id_cache_settings_post_oapg(
        self,
    ...
    def _edge_applications_edge_application_id_cache_settings_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_application_cache_create_request.serialize(body, content_type)
...
class EdgeApplicationsEdgeApplicationIdCacheSettingsPost(BaseApi):
    ...
    def edge_applications_edge_application_id_cache_settings_post(
        ...
        return self._edge_applications_edge_application_id_cache_settings_post_oapg(
            body=body,
