...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'phase': typing.Union[PhaseSchema, str, ],
...
request_path_phase = api_client.PathParameter(
    name="phase",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PhaseSchema,
    required=True,
...
# body param
SchemaForRequestBodyApplicationJsonVersion3 = PatchRulesEngineRequest


request_body_patch_rules_engine_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _edge_applications_edge_application_id_rules_engine_phase_rules_rule_id_patch_oapg(
        self,
    ...
    def _edge_applications_edge_application_id_rules_engine_phase_rules_rule_id_patch_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patch_rules_engine_request.serialize(body, content_type)
...
class EdgeApplicationsEdgeApplicationIdRulesEnginePhaseRulesRuleIdPatch(BaseApi):
    ...
    def edge_applications_edge_application_id_rules_engine_phase_rules_rule_id_patch(
        ...
        return self._edge_applications_edge_application_id_rules_engine_phase_rules_rule_id_patch_oapg(
            body=body,
