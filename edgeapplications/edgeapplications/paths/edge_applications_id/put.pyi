...
# body param
SchemaForRequestBodyApplicationJsonVersion3 = ApplicationPutRequest


request_body_application_put_request = api_client.RequestBody(
    content={
        'application/json; version=3': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJsonVersion3),
    },
)
SchemaFor200ResponseBodyApplicationJsonVersion3 = ApplicationPutResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _edge_applications_id_put_oapg(
        self,
    ...
    def _edge_applications_id_put_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_application_put_request.serialize(body, content_type)
...
class EdgeApplicationsIdPut(BaseApi):
    ...
    def edge_applications_id_put(
        ...
        return self._edge_applications_id_put_oapg(
            body=body,
