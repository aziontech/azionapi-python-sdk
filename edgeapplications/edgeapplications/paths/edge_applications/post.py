...
# body param
SchemaForRequestBodyApplicationJsonVersion3 = CreateApplicationRequest


request_body_create_application_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _edge_applications_post_oapg(
        self,
    ...
    def _edge_applications_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_application_request.serialize(body, content_type)
...
class EdgeApplicationsPost(BaseApi):
    ...
    def edge_applications_post(
        ...
        return self._edge_applications_post_oapg(
            body=body,
