...
class BaseApi(api_client.Api):
    @typing.overload
    def _edge_applications_edge_application_id_origins_get_oapg(
        self,
...
class EdgeApplicationsEdgeApplicationIdOriginsGet(BaseApi):
    ...
    def edge_applications_edge_application_id_origins_get(
        ...
        return self._edge_applications_edge_application_id_origins_get_oapg(
