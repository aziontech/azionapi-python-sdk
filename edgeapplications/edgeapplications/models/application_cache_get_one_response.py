...
class ApplicationCacheGetOneResponse(BaseModel):
    """
    ApplicationCacheGetOneResponse
    """
    results: ApplicationCacheResults = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationCacheGetOneResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationCacheGetOneResponse:
        """Create an instance of ApplicationCacheGetOneResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationCacheGetOneResponse.parse_obj(obj)

        _obj = ApplicationCacheGetOneResponse.parse_obj({
            "results": ApplicationCacheResults.from_dict(obj.get("results")) if obj.get("results") is not None else None,
