...
class RulesEngineResponse(BaseModel):
    ...
    results: conlist(RulesEngineResultResponse) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RulesEngineResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RulesEngineResponse:
        """Create an instance of RulesEngineResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RulesEngineResponse.parse_obj(obj)

        _obj = RulesEngineResponse.parse_obj({
            "count": obj.get("count"),
