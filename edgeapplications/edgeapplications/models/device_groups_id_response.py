...
class DeviceGroupsIdResponse(BaseModel):
    """
    DeviceGroupsIdResponse
    """
    results: DeviceGroupsResultResponse = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeviceGroupsIdResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeviceGroupsIdResponse:
        """Create an instance of DeviceGroupsIdResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeviceGroupsIdResponse.parse_obj(obj)

        _obj = DeviceGroupsIdResponse.parse_obj({
            "results": DeviceGroupsResultResponse.from_dict(obj.get("results")) if obj.get("results") is not None else None,
