...
class CreateOriginsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "origin_type", "addresses", "origin_protocol_policy", "host_header", "origin_path", "hmac_authentication", "hmac_region_name", "hmac_access_key", "hmac_secret_key", "bucket", "prefix"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addresses": [CreateOriginsRequestAddresses.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None,
