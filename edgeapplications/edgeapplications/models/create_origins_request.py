...
class CreateOriginsRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateOriginsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateOriginsRequest:
        """Create an instance of CreateOriginsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateOriginsRequest.parse_obj(obj)

        _obj = CreateOriginsRequest.parse_obj({
            "name": obj.get("name"),
