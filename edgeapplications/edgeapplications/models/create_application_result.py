...
class CreateApplicationResult(BaseModel):
    ...
    """
    results: ApplicationResultsCreate = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateApplicationResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateApplicationResult:
        """Create an instance of CreateApplicationResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateApplicationResult.parse_obj(obj)

        _obj = CreateApplicationResult.parse_obj({
            "results": ApplicationResultsCreate.from_dict(obj.get("results")) if obj.get("results") is not None else None,
