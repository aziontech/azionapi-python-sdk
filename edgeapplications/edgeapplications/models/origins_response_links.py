...
class OriginsResponseLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OriginsResponseLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OriginsResponseLinks:
        """Create an instance of OriginsResponseLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OriginsResponseLinks.parse_obj(obj)

        _obj = OriginsResponseLinks.parse_obj({
