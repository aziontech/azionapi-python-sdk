...
class ApplicationCachePatchResponse(BaseModel):
    """
    ApplicationCachePatchResponse
    """
    results: Optional[ApplicationCacheResponseDetails] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationCachePatchResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationCachePatchResponse:
        """Create an instance of ApplicationCachePatchResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationCachePatchResponse.parse_obj(obj)

        _obj = ApplicationCachePatchResponse.parse_obj({
            "results": ApplicationCacheResponseDetails.from_dict(obj.get("results")) if obj.get("results") is not None else None,
