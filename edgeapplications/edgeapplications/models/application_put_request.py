...
class ApplicationPutRequest(BaseModel):
    ...
    __properties = ["name", "delivery_protocol", "http_port", "https_port", "minimum_tls_version", "active", "application_acceleration", "caching", "device_detection", "edge_firewall", "edge_functions", "image_optimization", "l2_caching", "load_balancer", "raw_logs", "web_application_firewall", "debug_rules", "http3", "websocket", "supported_ciphers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationPutRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationPutRequest:
        """Create an instance of ApplicationPutRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationPutRequest.parse_obj(obj)

        _obj = ApplicationPutRequest.parse_obj({
            "name": obj.get("name"),
