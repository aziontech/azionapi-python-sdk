...
class ApplicationCacheCreateResponse(BaseModel):
    """
    ApplicationCacheCreateResponse
    """
    results: Optional[ApplicationCacheCreateResults] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationCacheCreateResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationCacheCreateResponse:
        """Create an instance of ApplicationCacheCreateResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationCacheCreateResponse.parse_obj(obj)

        _obj = ApplicationCacheCreateResponse.parse_obj({
            "results": ApplicationCacheCreateResults.from_dict(obj.get("results")) if obj.get("results") is not None else None,
