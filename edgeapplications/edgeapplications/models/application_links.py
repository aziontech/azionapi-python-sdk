...
class ApplicationLinks(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationLinks:
        """Create an instance of ApplicationLinks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationLinks.parse_obj(obj)

        _obj = ApplicationLinks.parse_obj({
