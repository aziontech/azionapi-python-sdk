...
class RulesEngineBehaviorEntry(BaseModel):
    """
    RulesEngineBehaviorEntry
    """

    # data type: RulesEngineBehaviorString
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if not isinstance(v, RulesEngineBehaviorString):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RulesEngineBehaviorString`")
        else:
            return v

        # validate data type: RulesEngineBehaviorObject
        if not isinstance(v, RulesEngineBehaviorObject):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RulesEngineBehaviorObject`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in RulesEngineBehaviorEntry with anyOf schemas: RulesEngineBehaviorObject, RulesEngineBehaviorString. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> RulesEngineBehaviorEntry:
        ...
        # anyof_schema_1_validator: Optional[RulesEngineBehaviorString] = None
        try:
            instance.actual_instance = RulesEngineBehaviorString.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[RulesEngineBehaviorObject] = None
        try:
            instance.actual_instance = RulesEngineBehaviorObject.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into RulesEngineBehaviorEntry with anyOf schemas: RulesEngineBehaviorObject, RulesEngineBehaviorString. Details: " + ", ".join(error_messages))
        else:
            return instance
