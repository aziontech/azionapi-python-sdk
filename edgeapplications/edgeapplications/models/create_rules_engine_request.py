...
class CreateRulesEngineRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateRulesEngineRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateRulesEngineRequest:
        """Create an instance of CreateRulesEngineRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateRulesEngineRequest.parse_obj(obj)

        _obj = CreateRulesEngineRequest.parse_obj({
            "name": obj.get("name"),
