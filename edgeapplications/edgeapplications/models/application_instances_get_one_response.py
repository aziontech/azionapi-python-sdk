...
class ApplicationInstancesGetOneResponse(BaseModel):
    """
    ApplicationInstancesGetOneResponse
    """
    results: ApplicationInstancesResults = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationInstancesGetOneResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationInstancesGetOneResponse:
        """Create an instance of ApplicationInstancesGetOneResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationInstancesGetOneResponse.parse_obj(obj)

        _obj = ApplicationInstancesGetOneResponse.parse_obj({
            "results": ApplicationInstancesResults.from_dict(obj.get("results")) if obj.get("results") is not None else None,
