...
class ApplicationCachePutResponse(BaseModel):
    """
    ApplicationCachePutResponse
    """
    results: ApplicationCacheResponseDetails = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationCachePutResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationCachePutResponse:
        """Create an instance of ApplicationCachePutResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationCachePutResponse.parse_obj(obj)

        _obj = ApplicationCachePutResponse.parse_obj({
