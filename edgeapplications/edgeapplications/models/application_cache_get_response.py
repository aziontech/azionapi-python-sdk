...
class ApplicationCacheGetResponse(BaseModel):
    ...
    results: conlist(ApplicationCacheResults) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationCacheGetResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationCacheGetResponse:
        """Create an instance of ApplicationCacheGetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationCacheGetResponse.parse_obj(obj)

        _obj = ApplicationCacheGetResponse.parse_obj({
            "count": obj.get("count"),
