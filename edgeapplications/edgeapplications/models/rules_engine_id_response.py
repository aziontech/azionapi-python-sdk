...
class RulesEngineIdResponse(BaseModel):
    """
    RulesEngineIdResponse
    """
    results: RulesEngineResultResponse = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RulesEngineIdResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RulesEngineIdResponse:
        """Create an instance of RulesEngineIdResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RulesEngineIdResponse.parse_obj(obj)

        _obj = RulesEngineIdResponse.parse_obj({
            "results": RulesEngineResultResponse.from_dict(obj.get("results")) if obj.get("results") is not None else None,
