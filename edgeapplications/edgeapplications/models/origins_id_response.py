...
class OriginsIdResponse(BaseModel):
    """
    OriginsIdResponse
    """
    results: OriginsResultResponse = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OriginsIdResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OriginsIdResponse:
        """Create an instance of OriginsIdResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OriginsIdResponse.parse_obj(obj)

        _obj = OriginsIdResponse.parse_obj({
            "results": OriginsResultResponse.from_dict(obj.get("results")) if obj.get("results") is not None else None,
