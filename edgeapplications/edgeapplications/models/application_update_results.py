...
class ApplicationUpdateResults(BaseModel):
    ...
    __properties = ["id", "name", "delivery_protocol", "http_port", "https_port", "minimum_tls_version", "active", "debug_rules", "http3", "supported_ciphers", "application_acceleration", "caching", "device_detection", "edge_firewall", "edge_functions", "image_optimization", "l2_caching", "load_balancer", "raw_logs", "web_application_firewall"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationUpdateResults:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationUpdateResults:
        """Create an instance of ApplicationUpdateResults from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationUpdateResults.parse_obj(obj)

        _obj = ApplicationUpdateResults.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
