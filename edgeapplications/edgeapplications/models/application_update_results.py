...
class ApplicationUpdateResults(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "delivery_protocol", "http_port", "https_port", "minimum_tls_version", "active", "debug_rules", "http3", "supported_ciphers", "application_acceleration", "caching", "device_detection", "edge_firewall", "edge_functions", "image_optimization", "l2_caching", "load_balancer", "raw_logs", "web_application_firewall", "websocket"]
