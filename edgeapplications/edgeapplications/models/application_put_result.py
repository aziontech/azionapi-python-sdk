...
class ApplicationPutResult(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationPutResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationPutResult:
        """Create an instance of ApplicationPutResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationPutResult.parse_obj(obj)

        _obj = ApplicationPutResult.parse_obj({
