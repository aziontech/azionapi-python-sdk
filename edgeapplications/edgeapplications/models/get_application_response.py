...
class GetApplicationResponse(BaseModel):
    ...
    """
    results: ApplicationResults = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetApplicationResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetApplicationResponse:
        """Create an instance of GetApplicationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetApplicationResponse.parse_obj(obj)

        _obj = GetApplicationResponse.parse_obj({
