...
class ApplicationInstanceResults(BaseModel):
    """
    ApplicationInstanceResults
    """
    schema_version: Optional[StrictInt] = None
    results: Optional[ApplicationInstancesResults] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationInstanceResults:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationInstanceResults:
        """Create an instance of ApplicationInstanceResults from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationInstanceResults.parse_obj(obj)

        _obj = ApplicationInstanceResults.parse_obj({
