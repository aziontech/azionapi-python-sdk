...
class CreateOriginsRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["addresses"], typing_extensions.Literal["name"], typing_extensions.Literal["host_header"], typing_extensions.Literal["origin_type"], typing_extensions.Literal["origin_protocol_policy"], typing_extensions.Literal["origin_path"], typing_extensions.Literal["hmac_authentication"], typing_extensions.Literal["hmac_region_name"], typing_extensions.Literal["hmac_access_key"], typing_extensions.Literal["hmac_secret_key"], ]):
