...
class ApplicationCachePatchResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def results() -> typing.Type['ApplicationCacheResponseDetails']:
                return ApplicationCacheResponseDetails
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'ApplicationCacheResponseDetails': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["schema_version"]) -> MetaOapg.properties.schema_version: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["results"], typing_extensions.Literal["schema_version"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> typing.Union['ApplicationCacheResponseDetails', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["results"], typing_extensions.Literal["schema_version"], ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        results: typing.Union['ApplicationCacheResponseDetails', schemas.Unset] = schemas.unset,
