...
class ApplicationCacheCreateResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def results() -> typing.Type['ApplicationCacheCreateResults']:
                return ApplicationCacheCreateResults
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'ApplicationCacheCreateResults': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> typing.Union['ApplicationCacheCreateResults', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        results: typing.Union['ApplicationCacheCreateResults', schemas.Unset] = schemas.unset,
