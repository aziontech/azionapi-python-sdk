...
class DeviceGroupsIdResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def results() -> typing.Type['DeviceGroupsResultResponse']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'DeviceGroupsResultResponse': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> 'DeviceGroupsResultResponse': ...
