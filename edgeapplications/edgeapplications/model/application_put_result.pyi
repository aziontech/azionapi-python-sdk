...
class ApplicationPutResult(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def results() -> typing.Type['ApplicationUpdateResults']:
                return ApplicationUpdateResults
    ...
    results: 'ApplicationUpdateResults'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["schema_version"]) -> MetaOapg.properties.schema_version: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'ApplicationUpdateResults': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> 'ApplicationUpdateResults': ...
