...
class RulesEngineResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def links() -> typing.Type['OriginsResponseLinks']:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['RulesEngineResultResponse']:
                        return RulesEngineResultResponse
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['RulesEngineResultResponse'], typing.List['RulesEngineResultResponse']],
                ...
                def __getitem__(self, i: int) -> 'RulesEngineResultResponse':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'OriginsResponseLinks': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> 'OriginsResponseLinks': ...
