        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ApplicationInstancesResults']:
                        return ApplicationInstancesResults
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ApplicationInstancesResults'], typing.List['ApplicationInstancesResults']],
                ...
                def __getitem__(self, i: int) -> 'ApplicationInstancesResults':
