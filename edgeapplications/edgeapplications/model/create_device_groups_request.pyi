...
class CreateDeviceGroupsRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user_agent"], typing_extensions.Literal["name"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user_agent"], typing_extensions.Literal["name"], ]):
