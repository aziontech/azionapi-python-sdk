...
conf = edgeapplications.Configuration(
    ...
    def __init__(
        ...
        """Constructor
        """
        self._base_path = "https://api.azionapi.net" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("edgeapplications")
