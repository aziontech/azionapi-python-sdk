...
from edgeapplications.models.application_update_response import ApplicationUpdateResponse  # noqa: E501
...
class TestApplicationUpdateResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ApplicationUpdateResponse`
        """
        model = edgeapplications.models.application_update_response.ApplicationUpdateResponse()  # noqa: E501
        if include_optional :
