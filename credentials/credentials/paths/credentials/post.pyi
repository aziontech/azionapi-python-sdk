...
# body param
SchemaForRequestBodyApplicationJsonVersion3 = CreateCredentialRequest


request_body_create_credential_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJsonVersion3 = AuthToken
...
class BaseApi(api_client.Api):
    ...
    def _create_credential_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_credential_request.serialize(body, content_type)
...
class CreateCredential(BaseApi):
    ...
    def create_credential(
        ...
        return self._create_credential_oapg(
            body=body,
