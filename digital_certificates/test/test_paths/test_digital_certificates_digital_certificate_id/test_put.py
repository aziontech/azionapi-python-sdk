...
from digital_certificates.paths.digital_certificates_digital_certificate_id import put  # noqa: E501
...
class TestDigitalCertificatesDigitalCertificateId(ApiTestMixin, unittest.TestCase):
    ...
    DigitalCertificatesDigitalCertificateId unit test stubs
        Overwrite a digital certificate with another complete digital certificate  # noqa: E501
    """
