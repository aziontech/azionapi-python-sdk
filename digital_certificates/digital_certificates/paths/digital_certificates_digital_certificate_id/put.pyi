...
SchemaFor200ResponseBodyApplicationJsonVersion3 = DC200
...
class BaseApi(api_client.Api):
    @typing.overload
    def _overwrite_digital_certificate_oapg(
        self,
...
class OverwriteDigitalCertificate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def overwrite_digital_certificate(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def overwrite_digital_certificate(
        ...
        return self._overwrite_digital_certificate_oapg(
            body=body,
