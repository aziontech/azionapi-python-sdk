...
SchemaFor200ResponseBodyApplicationJsonVersion3 = DC200List
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_digital_certificates_oapg(
        self,
...
class ListDigitalCertificates(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_digital_certificates(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_digital_certificates(
        ...
        return self._list_digital_certificates_oapg(
