...
class DC201(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errors", "schema_version", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errors", "schema_version", ], str]):
