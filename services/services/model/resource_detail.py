...
class ResourceDetail(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["content_type"], typing_extensions.Literal["name"], typing_extensions.Literal["id"], typing_extensions.Literal["trigger"], typing_extensions.Literal["content"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["content_type"], typing_extensions.Literal["name"], typing_extensions.Literal["id"], typing_extensions.Literal["trigger"], typing_extensions.Literal["content"], ]):
