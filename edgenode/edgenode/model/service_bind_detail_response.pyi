...
class ServiceBindDetailResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["variables"], typing_extensions.Literal["service_name"], typing_extensions.Literal["service_id"], typing_extensions.Literal["id"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["variables"], typing_extensions.Literal["service_name"], typing_extensions.Literal["service_id"], typing_extensions.Literal["id"], ]):
