...
class UnauthorizedEdgeNodeInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["reason"], typing_extensions.Literal["id"], ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["reason"], typing_extensions.Literal["id"], ]):
