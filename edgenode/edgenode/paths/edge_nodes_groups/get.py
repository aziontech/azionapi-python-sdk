...
class SchemaFor200ResponseBodyApplicationJsonVersion3(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['NodeGroupResponse']:
            return NodeGroupResponse

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['NodeGroupResponse'], typing.List['NodeGroupResponse']],
    ...
    def __getitem__(self, i: int) -> 'NodeGroupResponse':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_edge_node_groups_oapg(
        self,
...
class GetEdgeNodeGroups(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_edge_node_groups(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def get_edge_node_groups(
        ...
        return self._get_edge_node_groups_oapg(
