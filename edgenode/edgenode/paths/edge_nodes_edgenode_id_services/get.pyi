...
# Query params
IsBoundSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'is_bound': typing.Union[IsBoundSchema, bool, ],
...
request_query_is_bound = api_client.QueryParameter(
    name="is_bound",
    style=api_client.ParameterStyle.FORM,
    schema=IsBoundSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJsonVersion3 = ServiceResponseWithTotal
...
class GetEdgeNodeSvcs(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_edge_node_svcs(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_edge_node_svcs(
        ...
        return self._get_edge_node_svcs_oapg(
