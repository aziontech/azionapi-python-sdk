...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'only_ids': typing.Union[OnlyIdsSchema, bool, ],
...
SchemaFor200ResponseBodyApplicationJsonVersion3 = EdgeNodeResponseWithTotal
...
class GetEdgeNodes(BaseApi):
    ...
    def get_edge_nodes(
        ...
        return self._get_edge_nodes_oapg(
